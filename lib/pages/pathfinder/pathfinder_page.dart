...
*/
  ...
  Future<void> _getLocation() async {
    try {
      ...
      print("664");
      final LocationData currentLocation2 = await location.getLocation(); //crash
...
class _NewPageState extends State<NewPage> {
  ...
  void initState() {
    ...
    graph.keys.forEach((key) {
      ...
      for (var i = 0; i < graph[key]?['Connections'].length; i++) {
        ...
        x[y] = z;
        testkarte[key] = x; //ERROR ÜBERSCHREIBT VORHERIGEN EINTRAG
      }
    });
    print(testkarte);
    fill();
  ...
  int _currentIndex = 0;
  Map testkarte = {};
  var from = ('BuildingA', 'Level1', 'Room1');
  var to = ('BuildingA', 'Level2', 'Room6');

  // Test-Liste (unsinnige Einträge)
  final Map<dynamic, Map<String, dynamic>> graph = {
    ...
    ('BuildingA', 'Level1', 'Room2'): {
      ...
      'GPS': [],
      'Connections': [
        (('BuildingA', 'Level1', "Room3"), 1),
        (('BuildingA', 'Level1', 'Room1'), 1),
      ]
    },
    ...
    ('BuildingA', 'Level1', 'Room4'): {
      ...
      'GPS': [],
      'Connections': [
        (('BuildingA', 'Level2', "Room5"), 1),
        (('BuildingA', 'Level1', "Room3"), 1),
      ]
    },
    ('BuildingA', 'Level2', 'Room5'): {
      'Name': 'Room5',
      'Type': 'Room',
      'Coordinates': [1200, 600],
      'GPS': [],
      'Connections': [
        (('BuildingA', 'Level2', "Room6"), 1),
        (('BuildingA', 'Level1', "Room4"), 1),
      ]
    },
    ('BuildingA', 'Level2', 'Room6'): {
      'Name': 'Room',
      'Type': 'Room',
      'Coordinates': [1500, 900],
      'GPS': [],
      'Connections': [
        (('BuildingA', 'Level2', "Room5"), 1),
      ]
...
/* Tatsächliche Liste in bearbeitung und wird in seperate Datei verlargert => SH/0
  final Map<dynamic, Map<String, dynamic>> graph = {
    ('SH', '0', 'CulturCafe'): {
      'Name': 'Room1',
      'Type': 'Room',
      'Coordinates': [1300, 680],
      'GPS': [],
      'Connections': [
        (('SH', '0', 'Eingang ASTA'), 1),
      ]
    ...
    ('SH', '0', 'Eingang ASTA'): {
      ...
      'Connections': [
        (('SH', '0', 'CulturCafe'), 1),
        (('SH', '0', 'Eingang Studentenhaus'), 1),
        (('SH', '0', 'Wartebereich'), 1)
      ]
    },
    ('SH', '0', 'Eingang Studentenhaus'): {
      'Name': 'Room1',
      'Type': 'Room',
      'Coordinates': [1300, 780],
      'GPS': [],
      'Connections': [(('SH', '0', 'Eingang ASTA'), 1), (('SH', '0', 'CulturCafe'), 1), (('SH', '0', 'Raum 200'), 1)]
    },
    ('SH', '0', 'Raum 200'): {
      'Name': 'Room1',
      'Type': 'Room',
      'Coordinates': [750, 780],
      'GPS': [],
      'Connections': [(('SH', '0', 'Eingang Studentenhaus'), 1), (('SH', '0', 'Geeinschaftsraum 085'), 1)]
    },
    ('SH', '0', 'Geeinschaftsraum 085'): {
      'Name': 'Room1',
      'Type': 'Room',
      'Coordinates': [400, 750],
      'GPS': [],
    ...
    ('SH', '0', 'Wartebereich'): {
      'Name': 'Room1',
      'Type': 'Room',
      'Coordinates': [840, 1380],
      'GPS': [],
      'Connections': [
        (('SH', '0', 'WC 030'), 1),
        (('SH', '0', 'Büro 37/38/39/40'), 1),
        (('SH', '0', 'Eingang ASTA'), 1)
      ]
    },
    ('SH', '0', 'WC 030'): {
      ...
      'Coordinates': [840, 1380],
      'GPS': [],
      'Connections': [(('SH', '0', 'Wartebereich'), 1), (('SH', '0', 'Büro 37/38/39/40'), 1)]
    },
    ('SH', '0', 'Büro 37/38/39/40'): {
      'Name': 'Room1',
      'Type': 'Room',
      'Coordinates': [410, 1380],
      'GPS': [],
      'Connections': [(('SH', '0', 'WC 030'), 1)]
    },
    ('SH', '0', 'Büro 04-013'): {
      'Name': 'Room1',
      'Type': 'Room',
      'Coordinates': [1050, 2015],
      'GPS': [],
      'Connections': [(('SH', '0', 'WC 030'), 1), (('SH', '0', 'Büro 14/15/16/17/18'), 1)]
    },
    ('SH', '0', 'Büro 14/15/16/17/18'): {
      'Name': 'Room1',
      'Type': 'Room',
      'Coordinates': [1045, 2500],
      'GPS': [],
      'Connections': [(('SH', '0', 'Büro 04-013'), 1), (('SH', '0', 'Eingang Akaföe'), 1)]
    },
    ('SH', '0', 'Eingang Akaföe'): {
      'Name': 'Room1',
      'Type': 'Room',
      'Coordinates': [600, 2500],
      'GPS': [],
      'Connections': [
        (('SH', '0', 'Büro 14/15/16/17/18'), 1),
        (('SH', '0', 'Büro 062-072'), 1),
        (('SH', '0', 'Treppenhaus'), 1)
      ]
    },
    ('SH', '0', 'Büro 062-072'): {
      'Name': 'Room1',
      'Type': 'Room',
      'Coordinates': [380, 2500],
      'GPS': [],
      'Connections': [(('BuildingA', 'Level1', "Room2"), 1), (('SH', '0', 'Eingang Akaföe'), 1)]
    },
    ('SH', '0', 'Treppenhaus'): {
      'Name': 'Room1',
      'Type': 'Room',
      'Coordinates': [580, 2570],
      'GPS': [],
      'Connections': [(('BuildingA', 'Level1', "Room2"), 1), (('SH', '0', 'Eingang Akaföe'), 1)]
    },
  };
*/
  ...
  void _drawLine(img.Image image, Offset p1, Offset p2, img.Color color, int thickness) {
  ...
  Future<void> _loadImages(List<dynamic> shortestPath) async {
    ...
    for (int i = 0; i < filenames.length; i++) {
      ...
      for (int j = 0; j < _pointsList[i].length - 1; j++) {
        print("j");
        _drawLine(image, _pointsList[i][j], _pointsList[i][j + 1], img.ColorRgb8(0, 255, 255), 10);
      }
  ...
  Future<void> _validateAndPerformAction() async {
    ...
    if (startText.isNotEmpty && zielText.isNotEmpty) {
      ...
      final List<Uint8List> _images2 = await yourFunction(testkarte) as List<Uint8List>;
      print(_images);
      print(_pointsList);
      print(_currentIndex);
      print(testkarte);
